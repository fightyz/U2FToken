...
### Install(Use JCOP Shell Command)
1. Complie this Applet and upload to the JavaCard(>3.0)
2. Set the attestation certificate(with Extended APDU, CLA:F0, INS:01, P1,P2:00, Lc:000119):   
...
3. Set the attestation private key(CLA:F0, INS:02, P1,P2:00):  
